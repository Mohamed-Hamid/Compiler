...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		DFASimulator dfaSimulator = new DFASimulator("C:\\Users\\electric\\Dropbox\\College\\Term 9\\Programming Languages Translation\\Project phase 1\\Compiler\\test_program.txt", DFAInitialState);
